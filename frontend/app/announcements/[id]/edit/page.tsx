    ...
    if (announcement) {
      setFormData({
        ...
        endDate: announcement.endDate
          ...
          : '',
        targetBarangays: announcement.targetBarangays || [],
      })
      ...
      <Layout>
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <Link href="/announcements" className="text-primary-600 hover:text-primary-700">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {existingAttachments.length > 0 ? (
                ...
                <p className="text-sm text-gray-500 mb-4">No existing attachments</p>
              )}
            </div>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              ...
              >
                ...
                {loading || updateMutation.isLoading ? 'Updating...' : 'Update Announcement'}
              </button>
            </div>
          </div>
        </form>
